...
archivos.MOTIVO_NOTA_POR_DEFECTO = ""
r = archivos._referencia_nota(dict(NOTA_SIN_MOTIVO), "07", "FC03-000019")
...
archivos.MOTIVO_NOTA_POR_DEFECTO = "01"
r = archivos._referencia_nota(dict(NOTA_SIN_MOTIVO), "07", "FC03-000019")
...
r = archivos._referencia_nota(dict(NOTA_CON_MOTIVO), "07", "FC03-000020")
...
r = archivos._referencia_nota(sin_afectado, "07", "FC03-000021")
check(r is None, "si falta el documento afectado, sigue sin emitirse")

# 5) normalizacion: un "1" suelto se convierte en "01"
archivos.MOTIVO_NOTA_POR_DEFECTO = "1"
r = archivos._referencia_nota(dict(NOTA_SIN_MOTIVO), "07", "FC03-000022")
check(r and r[0] == "01", f"'1' se normaliza a '01' ({r[0] if r else None})")

# 6) nota de debito (08) con su propio catalogo
archivos.MOTIVO_NOTA_POR_DEFECTO = "01"
r = archivos._referencia_nota(dict(NOTA_SIN_MOTIVO), "08", "ND03-000001")
...
archivos.MOTIVO_NOTA_POR_DEFECTO = "99"
r = archivos._referencia_nota(dict(NOTA_SIN_MOTIVO), "07", "FC03-000023")
